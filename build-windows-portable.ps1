...
<#
  Build a portable Windows distribution for Vita Machina.

  Output layout:
    dist\Vita Machina\Vita Machina.exe
    dist\Vita Machina\static\...
    dist\Vita Machina\scripts\...
    dist\Vita Machina\mcp_servers\...
    dist\Vita Machina\services\hwfit\data\...
...
& $pyExe -m PyInstaller --noconfirm --clean --onedir --noconsole --icon=static/icon.ico --name "Vita Machina" @dataArgs launcher.py
if ($LASTEXITCODE -ne 0) { Fail "PyInstaller build failed." }

Write-Host ""
Write-Host "Build complete." -ForegroundColor Green
Write-Host "Portable app folder: $PSScriptRoot\dist\Vita Machina" -ForegroundColor Green
