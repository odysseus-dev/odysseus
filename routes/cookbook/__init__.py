"""Cookbook routes package — split from cookbook_routes.py.
...
# Re-import helpers from _utils for module-level access within setup_cookbook_routes
from routes.cookbook._utils import (
    _venv_root_from_serve_cmd,
    _append_venv_nvidia_library_path_lines,
    _serve_port_from_cmd,
    _append_openai_port_preflight_lines,
    _is_generated_ollama_docker_exec_cmd,
    _missing_binary_message,
    _remote_binary_available,
    _remote_posix_path_prefix,
    _remote_tmux_command,
    _remote_tmux_launch_command,
    _binary_available,
            ...
            if existing:
                ...
                try:
                    if mlx_shim_model_id:
                        ...
                        from routes.model import _probe_endpoint
