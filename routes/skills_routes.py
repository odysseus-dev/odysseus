...
from src.services.skill_runner import _skill_test_task, _run_skill_test_once, _eval_skill_run
# ARCH-P7-02 / P8-T15: audit primitives + the shared job store moved to the
# service. Import them FROM the service (dependency inverted) so the route
# handlers and src/builtin_actions.py mutate the SAME _skill_audit_jobs dict.
from src.services.skill_runner import (  # noqa: F401
    _skill_audit_jobs,
    _resolve_audit_models,
    _run_audit_all_job,
    get_skill_audit_jobs,
)
...
# _skill_test_task re-exported from src.services.skill_runner (imported above)


# _eval_skill_run re-exported from src.services.skill_runner (imported above)
...
# _skill_audit_jobs is imported from src.services.skill_runner (P8-T15).
...
# _run_skill_test_once re-exported from src.services.skill_runner (imported above)
