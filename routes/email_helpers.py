...
# ARCH-P7-01 / P8-T14: the SMTP/IMAP/config/scheduled-DB primitives moved to
# src/services/email_send.py. Import them FROM the service (dependency inverted)
# so they remain available under their original names to the rest of this module
# and to other route modules that import them from routes.email_helpers.
from src.services.email_send import (  # noqa: F401
    _smtp_security_mode,
    _send_smtp_message,
    _smtp_ready,
    _load_settings,
...
# DATA_DIR / SETTINGS_FILE / SCHEDULED_DB are imported from
# src.services.email_send (P8-T14), which sources them from src.constants.
