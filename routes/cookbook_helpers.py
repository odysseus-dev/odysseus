...
def _validate_serve_cmd(v: str | None) -> str | None:
    ...
    # Strip safe Windows PowerShell $env:VAR="val"; prefixes generated by the
    # client-side llamacpp cmd builder (CUDA_VISIBLE_DEVICES, GGML_CUDA_*).
    # Values must not contain quotes, semicolons, newlines, or backticks.
    cleaned_v = re.sub(
