...
_HF_TOKEN_STATUS_SNIPPET = (
    ...
    'Add one in Hellaine Cookbook -> Settings -> HuggingFace Token."; '
    'fi'
)
        ...
        patterns = [
            ...
            (
                ...
                [
                    ...
                    {"label": "Hellaine now rewrites MLX repo-id launches to a cached snapshot when one exists", "op": "manual"},
                ],
            ),
    ...
    async def model_serve(request: Request, req: ServeRequest):
        ...
        if is_windows and remote:
            ...
            if ("llama_cpp" in req.cmd or "llama-server" in req.cmd) and not local_windows_llama_cmd:
                ...
                runner_lines.append('# Auto-generated by Hellaine Cookbook: a `llama-server` lookalike')
                ...
                if remote and _ollama_host in ("0.0.0.0", "::"):
                    runner_lines.append('echo "[odysseus] WARNING: remote Ollama will bind to ${ODYSSEUS_OLLAMA_HOST}:${ODYSSEUS_OLLAMA_PORT} so Hellaine can reach it from this host."')
