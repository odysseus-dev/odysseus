    ...
    async def model_serve(request: Request, req: ServeRequest):
        ...
        if is_windows and remote:
            ...
            if "llama_cpp" in req.cmd or "llama-server" in req.cmd:
                ...
                runner_lines.append('      CUDA_BIN=$(command -v nvcc 2>/dev/null || echo "/usr/local/cuda/bin/nvcc")')
                ...
                runner_lines.append('      ROCM_BIN=$(command -v hipcc 2>/dev/null || echo "/opt/rocm/bin/hipcc")')
                ...
                runner_lines.append('      SYCL_BIN=$(command -v icpx 2>/dev/null || echo "/opt/intel/oneapi/compiler/latest/bin/icpx")')
                ...
                runner_lines.append('    fi')
                runner_lines.append('    CMAKE_ARGS="$CMAKE_ARGS" pip install --user --break-system-packages -q llama-cpp-python 2>/dev/null || CMAKE_ARGS="$CMAKE_ARGS" pip install -q llama-cpp-python 2>/dev/null || true')
                runner_lines.append('  fi')
                runner_lines.append('fi')
