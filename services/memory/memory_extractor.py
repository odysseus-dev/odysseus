...
EXTRACT_SYSTEM_PROMPT = (
    ...
    "Do NOT store:\n"
    "- Fictional character sheets, RPG stats, lore from image tests (unless user says remember this character).\n"
    "- NSFW preferences from image-generation testing.\n"
    "- Fictional character details as facts about the USER.\n"
    "- One-off image params (seed, tags) from a single run.\n\n"
    "Rules:\n"
