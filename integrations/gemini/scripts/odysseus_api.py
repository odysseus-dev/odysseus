#!/usr/bin/env python3
"""Small Odysseus scoped API helper for Gemini CLI terminal sessions."""
...
def _config() -> tuple[str, str] | None:
    ...
    if missing:
        print(f"missing {', '.join(missing)}; create a Gemini Agent token in Odysseus Settings", file=sys.stderr)
        return None
