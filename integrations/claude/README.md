# Vita Machina Claude Code Integration

This directory contains the Claude Code skill bundle for Vita Machina.
...
The token is scope-gated. Every tool surface is checked server-side in Vita Machina,
