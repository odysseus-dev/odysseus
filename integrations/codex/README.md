# Vita Machina Codex Integration

This directory contains the Codex plugin/skill bundle for Vita Machina.

## User Flow

1. Open Vita Machina Settings > Integrations.
2. Add a Codex Agent.
...
Codex must use `/api/codex/*` endpoints. SSH, Docker, direct Python imports, database queries, and MCP internals bypass Vita Machina Settings and must not be used for user data access.
