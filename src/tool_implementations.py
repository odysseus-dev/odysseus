...
async def do_create_document(
    content_block: str, session_id: str | None = None, owner: str | None = None
) -> dict:
...
async def do_update_document(
    content: str, doc_id: str | None = None, owner: str | None = None
) -> dict:
...
async def do_suggest_document(
    content: str, doc_id: str = None, owner: str | None = None
) -> dict:
