...
def _build_base_prompt(
    ...
    """
    from src.domain.agent.tools.tool_index import ALWAYS_AVAILABLE
...
async def stream_agent_loop(
    ...
    if not guide_only and not _relevant_tools:
        try:
            from src.domain.agent.tools.tool_index import get_tool_index, ALWAYS_AVAILABLE
    ...
    if not guide_only and not _relevant_tools and _retrieval_query:
        from src.domain.agent.tools.tool_index import ALWAYS_AVAILABLE, ToolIndex
        _relevant_tools = set(ALWAYS_AVAILABLE)
