...
from src.domain.chat.chat_helpers import extract_urls, model_supports_vision
from src.domain.document.document_processor import build_user_content, analyze_image_with_vl_result
from src.domain.document.youtube_handler import (
    is_youtube_url,
    extract_youtube_id,
