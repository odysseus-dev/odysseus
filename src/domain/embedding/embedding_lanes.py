...
def reset_embedding_lane_state() -> None:
    ...
    try:
        from src.domain.embedding.embeddings import reset_http_embed_state
...
def _load_custom_endpoint() -> Dict[str, str]:
    try:
        from src.domain.embedding.embeddings import _load_persisted_endpoint
...
def _build_fastembed_client():
    from src.domain.embedding.embeddings import FastEmbedClient
...
def _build_custom_client():
    from src.domain.embedding.embeddings import EmbeddingClient, get_embedding_client
