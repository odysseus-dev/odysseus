...
Streaming agent loop for juniperus-ui.
...
```
GENERIC LOOPBACK to ANY Juniperus internal endpoint. Use this whenever the user wants something the UI can do but there's NO named tool for it. Every UI button hits some /api/* endpoint — you can hit the same one. Auth is handled automatically.
