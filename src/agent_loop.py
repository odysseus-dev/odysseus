...
- Use `edit_file`/`write_file` for writes; avoid shell redirection/heredocs for editing files.""",
    "settings": """\
## Settings/API rules
- Use `manage_settings` for preferences and to turn a tool off / list disabled tools (re-enabling a disabled tool is admin-only, in Settings).
