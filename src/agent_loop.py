...
- You have the same built-in tools as Chat mode (web_search, manage_memory, manage_tasks, documents, email, calendar, etc.) — use them instead of guessing or claiming you cannot access them.
