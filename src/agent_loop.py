...
- For local Ollama models that lack native tool calling, create or edit files with the `bash` tool (heredoc or printf) instead of claiming you cannot write files.
