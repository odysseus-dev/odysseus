...
`calendar` accepts a name ("Main") or short-id prefix.""",
    ...
    "ask_user": "- ```ask_user``` — Ask the user one multiple-choice question, or a batch of 1-4 questions, when the task is genuinely ambiguous and the answer changes what you do next (pick an approach, confirm an assumption, choose a target). Legacy args (JSON): {\"question\": \"...\", \"options\": [{\"label\": \"...\", \"description\": \"...\"?}, ...], \"multi\": false?}. Batched args: {\"questions\": [{\"question\": \"...\", \"header\": \"...\"?, \"options\": [{\"label\": \"...\", \"description\": \"...\"?}, ...], \"multiSelect\": false?}]}. The user gets clickable buttons; calling this ENDS your turn and their choice comes back as your next message. Prefer sensible defaults — only ask when you truly can't proceed well without their input.",
