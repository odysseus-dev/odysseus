...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "resolve_contact": "Look up a contact's email address or phone number by name. Searches CardDAV address book and sent email history. Returns email when available; falls back to phone number for contacts that have no email. Use when the user says 'message [name]', 'email [name]', 'call [name]', or 'send to [name]' without contact details.",
