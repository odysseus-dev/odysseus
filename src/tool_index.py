...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "forge": "Read-only GitHub/GitLab queries via the gh/glab CLI (auto-detected): list/view/status/diff/checks for pull/merge requests, issues, releases. Use to inspect or review a PR/MR or issue. Mutating actions (create/comment/close/edit/merge) are not available yet.",
