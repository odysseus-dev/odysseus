...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "nextcloud_read_file": "Read a text file from the user's configured Nextcloud / ownCloud into context (WebDAV GET, read-only). Use when the user asks to read, open, summarize, or show a file that lives on their Nextcloud. Content is capped (configurable); binary files may not be useful.",
