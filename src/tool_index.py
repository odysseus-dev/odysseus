...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "get_workspace": "Return the absolute path of the active workspace folder the user is working in. File tools are confined to it; shell commands start there inside the process sandbox. Call this first when the user refers to 'the project'/'the code'/'this folder' without giving a path, instead of asking them.",
