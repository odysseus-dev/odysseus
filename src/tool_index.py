...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "powershell": "Run Windows PowerShell commands on the server. Use for explicit PowerShell, PS, or pwsh requests; Windows-native commands; registry, services, WMI/CIM; and user PATH commands that do not resolve in Git Bash. Prefer dedicated file tools for reading, writing, editing, searching, and listing files.",
