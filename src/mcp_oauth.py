...
Registration, authorization-code + PKCE, token refresh) to Vita Machina's web
...
# on Vita Machina. APP_PORT is intentionally not used: it is only the Docker host
