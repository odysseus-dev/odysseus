...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Juniperus-Origin"] = "juniperus-ui"
            msg["X-Juniperus-Kind"] = "task"
            msg["X-Juniperus-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Juniperus-Origin": "juniperus-ui",
                "X-Juniperus-Kind": "task",
                "X-Juniperus-Ref": str(task.id),
            },
        }
        if recipient:
