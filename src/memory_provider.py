...
class MemoryProvider(ABC):
    """Base contract for Vita Machina memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for Vita Machina' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "Vita Machina native memory"
