...
class ModelDiscovery:
    ...
    def discover_models(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        # occupied by Ollama, 52625 (FastFlowLM — Ryzen AI NPU runtime).
        # The env vars can add more ports which will be merged in.
        ports = list(range(8000, 8021)) + [1234, 11434, 11435, 52625]
