...
MCP_DISABLED = os.environ.get("VOID_DISABLE_MCP", "").lower() in ("1", "true", "yes")
...
async def register_builtin_servers(mcp_manager):
    ...
    if MCP_DISABLED:
        logger.info("Built-in MCP servers disabled via VOID_DISABLE_MCP")
        return
