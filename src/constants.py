...
# `or` (not getenv's default arg) so an explicitly-empty FASTEMBED_CACHE_PATH=
# (e.g. Docker Compose passing ${FASTEMBED_CACHE_PATH:-}) falls back to the data
# dir instead of resolving to '' and crashing os.makedirs('') at FastEmbed init.
