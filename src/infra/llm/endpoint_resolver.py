...
from src.infra.llm.llm_core import _detect_provider, _host_match, _ollama_api_root
...
def resolve_endpoint_runtime(ep, owner: Optional[str] = None) -> Tuple[str, Optional[str]]:
    ...
    if auth_id:
        from src.infra.integration.chatgpt_subscription import resolve_runtime_credentials
...
def build_headers(api_key: Optional[str], base: str) -> Dict[str, str]:
    ...
    if provider == "chatgpt-subscription":
        from src.infra.integration.chatgpt_subscription import chatgpt_headers
