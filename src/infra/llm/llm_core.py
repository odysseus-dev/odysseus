...
from src.domain.context.model_context import get_context_length, DEFAULT_CONTEXT
...
def _detect_provider(url: str) -> str:
    ...
    from src.infra.integration.copilot import is_copilot_base
...
def _provider_headers(provider: str, headers: Optional[Dict] = None) -> Dict[str, str]:
    ...
    if provider == "copilot":
        ...
        from src.infra.integration.copilot import copilot_headers
...
def _build_chatgpt_responses_payload(
    ...
    *,
    ...
    from src.infra.integration.chatgpt_subscription import build_responses_input
    ...
    *,
    ...
    try:
        ...
        if provider == "ollama":
            ...
            from src.infra.llm.endpoint_resolver import build_models_url
...
def llm_call(url: str, model: str, messages: List[Dict], temperature: float = LLMConfig.DEFAULT_TEMPERATURE,
    ...
    if provider == "anthropic":
        ...
        target_url = url
        if provider == "copilot":
            from src.infra.integration.copilot import apply_request_headers
