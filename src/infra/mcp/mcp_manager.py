...
class McpManager:
    ...
    async def _start_http_connect(self, server_id: str, name: str, url: str, wait: float = 8.0) -> bool:
        ...
        from src.infra.mcp.mcp_oauth import pop_auth_url
    ...
    async def _connect_http(self, server_id: str, name: str, url: str) -> bool:
        ...
        try:
            ...
            from contextlib import AsyncExitStack
            from src.infra.mcp.mcp_oauth import build_provider, clear_auth_url
    ...
    async def disconnect_server(self, server_id: str):
        ...
        if task is not None and not task.done():
            task.cancel()
        try:
            from src.infra.mcp.mcp_oauth import clear_auth_url
            clear_auth_url(server_id)
        except Exception:
            pass
    ...
    async def _reconnect_builtin(self, server_id: str) -> bool:
        ...
        import sys
        from src.infra.mcp.builtin_mcp import _BUILTIN_SERVERS
