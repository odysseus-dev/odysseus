...
Imports MemoryManager and MemoryVectorStore from the Void codebase.
"""
...
_OWNER_ENV_KEYS = ("VOID_MCP_MEMORY_OWNER", "VOID_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set VOID_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
