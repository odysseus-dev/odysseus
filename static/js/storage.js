...
// ── Key constants ──
export const KEYS = {
  THEME: 'juniperus-theme',
  TOGGLES: 'juniperus-toggles',
  ...
  MODELS_EXPANDED: 'juniperus-model-expanded',
  MODEL_ENDPOINTS: 'juniperus-model-endpoints',
  MODEL_SELECTED: 'juniperus-selected-model',
  SORT_ORDER: 'juniperus-sessions-sort',
  CHAT_SEARCH_SCOPE: 'juniperus-search-scope',
  INCOGNITO: 'juniperus-incognito',
  RAG_ACTIVE: 'juniperus-rag-active',
  MCP_ACTIVE: 'juniperus-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'juniperus-density'
};
