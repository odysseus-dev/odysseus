...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'void-model-expanded',
  MODEL_ENDPOINTS: 'void-model-endpoints',
  MODEL_SELECTED: 'void-selected-model',
  SORT_ORDER: 'void-sessions-sort',
  CHAT_SEARCH_SCOPE: 'void-search-scope',
  INCOGNITO: 'void-incognito',
  RAG_ACTIVE: 'void-rag-active',
  MCP_ACTIVE: 'void-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'void-density',
  UI_SCALE: 'void-ui-scale',
