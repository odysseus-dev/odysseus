...
const _PROVIDERS = [
  // NobodyWho — in-process llama.cpp inference (minimal take on its neutral-face icon)
  [/nobodywho/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><ellipse cx="8.2" cy="9.5" rx="1.9" ry="2.7"/><ellipse cx="15.8" cy="9.5" rx="1.9" ry="2.7"/><rect x="7" y="15.2" width="10" height="2.4" rx="1.2"/></svg>'],
