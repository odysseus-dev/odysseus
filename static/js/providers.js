...
const _PROVIDERS = [
  ...
  // Venice — privacy-first, OpenAI-compatible (stylized V mark)
  [/venice/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2 2 6v6c0 5.25 4 9.13 10 10 6-0.87 10-4.75 10-10V6L12 2Zm0 2.18 8 3.2v4.62c0 4.06-3 7.06-8 7.79-5-0.73-8-3.73-8-7.79V7.38l8-3.2Zm-4 4.32 4 8 4-8h-2l-2 4-2-4H8Z"/></svg>'],
