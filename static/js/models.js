...
const COLLAPSE_KEY = 'juniperus-models-collapsed';
const FAVORITES_KEY = 'juniperus-model-favorites';
const USAGE_KEY = 'juniperus-model-usage';
const SORT_KEY = 'juniperus-model-sort';
