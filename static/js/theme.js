...
const CUSTOM_THEMES_KEY = 'void-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Void Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'void-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'void_' + (obj.name || 'theme') + '.json';
      a.click();
