...
const LS_KEY = 'juniperus-theme';
const CUSTOM_THEMES_KEY = 'juniperus-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Juniperus Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'juniperus_' + (obj.name || 'theme') + '.json';
      a.click();
