...
export function initSectionCollapse(Storage) {
  const _chevronHtml = `<button type="button" class="section-collapse-btn" title="${window.t('Collapse section')}"><svg class="section-collapse-chevron" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg></button>`;
