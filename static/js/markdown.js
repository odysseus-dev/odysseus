...
function initMermaid() {
  if (!window.mermaid || window.__juniperusMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__juniperusMermaidReady = true;
}
window.juniperusInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'juniperus-thinking-expanded';
