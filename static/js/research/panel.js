...
function _renderJobs() {
  ...
  const _addSection = (key, title, arr) => {
    ...
    if (key === 'past') {
      ...
      hint.innerHTML = '<span>' + window.t('All past research found in:') + '</span> <button type="button" class="research-library-link">' + window.t('Library, Research') + '</button>';
