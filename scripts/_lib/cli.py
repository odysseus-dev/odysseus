"""scripts/_lib/cli.py — shared scaffolding for the `juniperus-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("juniperus-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/juniperus-foo`
...
VERSION = "0.1.0"  # bumped centrally; every juniperus-* CLI reports this
