#!/usr/bin/env python3
"""Create/remove the switchable, non-default 'Demo' EmailAccount in Juniperus.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@juniperus.local mailbox. Password is stored Fernet-encrypted
...
NAME = "Demo"
IMAP_USER = "demo@juniperus.local"
