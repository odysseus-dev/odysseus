...
def main():
    ...
    # Enable the Xet high-perf downloader if available — big throughput win.
    # Must be set before importing huggingface_hub. Falls back to the legacy
    # hf_transfer flag for older hub versions that predate Xet.
    try:
