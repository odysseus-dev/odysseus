...
INTERNAL_TOOL_TOKEN = os.environ.get("VOID_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Void-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Void-Internal-Token), or
