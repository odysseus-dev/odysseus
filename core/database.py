...
def init_db():
    ...
    # Versioned, ordered, fail-loud migration runner replaces the unconditional
    # post-create _migrate_* sequence. Deferred import avoids a cycle:
    # core.db_migration_runner imports the _migrate_* callables from this module.
