...
Vita Machina began as a Linux/macOS/Docker-only app. This module centralizes the
...
def find_bash() -> Optional[str]:
    ...
    On Windows this is typically Git Bash / WSL. Many Vita Machina features (the
