...
# triggers match, they outrank auto-migrated neurons so the character leads the
# voice — the generic persona-* entries fire only as supporting material.
PROTECTED_NEURONS = {"persona-example", "method-core"}
