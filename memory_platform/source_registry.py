...
The rule that fixes game-rule material: mining/game-rule material is `know`
only — it is retrievable and referenceable but can NEVER enter speech or
identity unless the user explicitly adopts it as an influence. A book is a
resource, not a self.
