...
AFFIRM_DICT = {
    ...
    "do not touch the production server": "I protect the production environment and ask before touching it",
    "never touch the production server": "I protect the production environment and ask before touching it",
    "ask permission before modifying anything on the server": "I check with the user before touching anything on the server",
