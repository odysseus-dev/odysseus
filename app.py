...
# ========= AUTH =========
from src.api.router.auth_routes import setup_auth_routes, SESSION_COOKIE
...
if AUTH_ENABLED:
    ...
    class AuthMiddleware(BaseHTTPMiddleware):
        async def dispatch(self, request: Request, call_next):
            ...
            try:
                from src.api.middleware.security_headers import INTERNAL_TOOL_HEADER, INTERNAL_TOOL_TOKEN as _ITT
...
# Uploads
from src.api.router.upload_routes import setup_upload_routes
...
from src.api.router.emoji_routes import setup_emoji_routes
app.include_router(setup_emoji_routes())

# Sessions
from src.api.router.session_routes import setup_session_routes
...
# Memory
from src.api.router.memory_routes import setup_memory_routes
memory_router = setup_memory_routes(memory_manager, session_manager, memory_vector=memory_vector)
app.include_router(memory_router)
from src.api.router.skills_routes import setup_skills_routes
...
# History
from src.api.router.history_routes import setup_history_routes
app.include_router(setup_history_routes(session_manager))

# Search
from src.api.router.search_routes import setup_search_routes
...
# Diagnostics
from src.api.router.diagnostics_routes import setup_diagnostics_routes
app.include_router(setup_diagnostics_routes(rag_manager, rag_available, research_handler, memory_vector))

# Cleanup
from src.api.router.cleanup_routes import setup_cleanup_routes
app.include_router(setup_cleanup_routes(session_manager))

# Personal docs
from src.api.router.personal_routes import setup_personal_routes
app.include_router(setup_personal_routes(personal_docs_mgr, rag_manager, rag_available))

# Embedding model management
from src.api.router.embedding_routes import setup_embedding_routes
...
from src.api.router.copilot_routes import setup_copilot_routes
app.include_router(setup_copilot_routes())

# ChatGPT Subscription device-flow login
from src.api.router.chatgpt_subscription_routes import setup_chatgpt_subscription_routes
app.include_router(setup_chatgpt_subscription_routes())

# TTS
from src.api.router.tts_routes import setup_tts_routes
app.include_router(setup_tts_routes(tts_service))

# STT
from services.stt import get_stt_service
stt_service = get_stt_service()
from src.api.router.stt_routes import setup_stt_routes
app.include_router(setup_stt_routes(stt_service))
logger.info("STT service initialized (provider managed via settings)")

# Documents (artifacts/canvas)
from src.api.router.document_routes import setup_document_routes
document_router = setup_document_routes(session_manager, upload_handler)
app.include_router(document_router)

# Signatures (reusable image stamps)
from src.api.router.signature_routes import setup_signature_routes
app.include_router(setup_signature_routes())

# Gallery (image library)
from src.api.router.gallery_routes import setup_gallery_routes
app.include_router(setup_gallery_routes())

# Persisted image-editor drafts (server-backed projects)
from src.api.router.editor_draft_routes import setup_editor_draft_routes
...
from src.api.router.assistant_routes import setup_assistant_routes
app.include_router(setup_assistant_routes(task_scheduler))

# Calendar (CalDAV)
from src.api.router.calendar_routes import setup_calendar_routes
calendar_router = setup_calendar_routes()
app.include_router(calendar_router)

# Shell (user-facing command execution)
from src.api.router.shell_routes import setup_shell_routes
app.include_router(setup_shell_routes())

# Cookbook (model download/serve/cache, cookbook state sync)
from src.api.router.cookbook_routes import setup_cookbook_routes
...
# User Preferences
from src.api.router.prefs_routes import setup_prefs_routes
...
from src.api.router.font_routes import setup_font_routes
...
# Webhooks
from src.api.router.webhook_routes import setup_webhook_routes
app.include_router(setup_webhook_routes(webhook_manager, auth_manager, session_manager, api_key_manager))

# API Tokens
from src.api.router.api_token_routes import setup_api_token_routes
...
from src.api.router.note_routes import setup_note_routes
app.include_router(setup_note_routes(task_scheduler))

# Email
from src.api.router.email_routes import setup_email_routes
...
from src.api.router.codex_routes import setup_codex_routes, setup_claude_routes
...
from src.api.router.vault_routes import setup_vault_routes
    ...
    async def _skill_audit_nightly_loop():
        ...
        while True:
            ...
            try:
                ...
                from src.api.router.skills_routes import run_scheduled_skill_audit
