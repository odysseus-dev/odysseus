...
## Features
  ...
  - **Generative UI** -- ask for dashboards, charts, tables, and forms right inside chat or documents.<br>　<sub>uses [OpenUI](https://github.com/thesysdev/openui) · live previews · interactive controls · model-generated apps</sub>
