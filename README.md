...
## Features
  ...
  - **Email** -- IMAP/SMTP inbox with AI triage built in: urgency reminders, auto-tag, auto-summary, auto-reply drafts, auto-spam.<br>　<sub>IMAP · SMTP · OAuth (Microsoft 365 via Graph · Google Workspace) · per-account routing · CalDAV-aware</sub>
