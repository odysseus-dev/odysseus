...
A self-hosted AI workspace inspired by the UI of ChatGPT and Claude, but with more jank and fun. It runs on your own hardware, with your own data, with a local-first, privacy-first principle.

## Features
  - **Chat** -- Chat with any local model or API; adding them is super simple.<br>　<sub>vLLM · llama.cpp · Ollama · OpenRouter · OpenAI</sub>
  - **Agent** -- Hand ai tools and let it complete the whole task itself.<br>　<sub>built on [opencode](https://github.com/anomalyco/opencode) · MCP · web · files · shell · skills · memory</sub>
