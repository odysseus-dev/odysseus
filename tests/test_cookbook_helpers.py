...
def test_llama_cpp_rebuild_cmd_clears_cached_build_paths():
    ...
    assert 'ODYSSEUS_LLAMA_CPP_DIR="${ODYSSEUS_LLAMA_CPP_DIR:-$HOME/.local/llama.cpp}"' in cmd
    assert 'ODYSSEUS_LLAMA_CPP_BIN_DIR="${ODYSSEUS_LLAMA_CPP_BIN_DIR:-$HOME/.local/bin}"' in cmd
