...
def test_rag_id_stability_across_processes():
    ...
    cmd = [sys.executable, "-c", "from src.domain.rag.rag_vector import _generate_doc_id; print(_generate_doc_id('test_text_hash'))"]
    ...
    cmd_diff = [sys.executable, "-c", "from src.domain.rag.rag_vector import _generate_doc_id; print(_generate_doc_id('different_text_hash'))"]
