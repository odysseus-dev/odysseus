...
def test_detached_resume_surfaces_fallback_then_provider_alias_before_reload():
    source = "\n".join([
        ...
        "const _resumingStreams = new Set(); const _streamRunIds = new Map(); const _activeStreams = new Map(); const API_BASE = '';",
        "function _syncForegroundStreamGlobals() {} function _touchStreamActivity() {} function updateSubmitButton() {}",
