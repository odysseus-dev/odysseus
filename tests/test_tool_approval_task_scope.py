...
def test_route_context_agent_frontend_and_cache_bust_wire_the_contract():
    ...
    chat_version = "20260823integration1"
    renderer_version = "20260819approvalcontrol1"
    assert f"chat.js?v={chat_version}" in app
    assert f"chat.js?v={chat_version}" in index
