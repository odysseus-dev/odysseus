...
from core.database import AgentRunRecord, ChatMessage, DocumentVersion, Session, TaskRun, UserToolData, utcnow_naive
...
def test_database_timestamp_defaults_use_utcnow_naive():
    defaults = (
        ...
        AgentRunRecord.started_at.default.arg,
        AgentRunRecord.updated_at.default.arg,
        AgentRunRecord.updated_at.onupdate.arg,
    )
