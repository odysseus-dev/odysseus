"""`void-research list --status complete` was returning nothing.
...
Part of #2122 (void-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "void-research"
    loader = importlib.machinery.SourceFileLoader("void_research_cli", str(path))
