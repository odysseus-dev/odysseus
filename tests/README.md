...
```text
[order-report] working directory: /path/to/void
...
[order-report] reproduce with: /path/to/void/venv/bin/python /path/to/void/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
