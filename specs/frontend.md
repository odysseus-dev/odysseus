...
`static/js/sessions.js` also owns the lightweight Projects sidebar view: project fetch/state, creating projects, moving chats into projects, starting a new pending chat inside a project, and showing project names in the chat header.
