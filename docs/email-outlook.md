...
Vita Machina email accounts currently use IMAP and SMTP with username/password
...
This is expected. Vita Machina does not support Microsoft OAuth or Graph Mail yet,
